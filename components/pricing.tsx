...
export function Pricing() {
  return (
    <section id="pricing" aria-labelledby="pricing-title" className="py-16 md:py-20 bg-secondary/40">
          ...
          {tiers.map((t) => (
            <Card key={t.name} className="reveal">
              ...
              <CardContent className="p-6 pt-0">
                ...
                <Button asChild className="mt-5 bg-primary text-primary-foreground w-full">
